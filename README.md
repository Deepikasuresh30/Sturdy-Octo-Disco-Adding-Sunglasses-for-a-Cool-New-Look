...
# Load the face image
img = cv2.imread("C:/Users/admin/OneDrive/Pictures/Screenshots/Screenshot 2025-02-12 204834.png")
plt.imshow(img[:,:,::-1]); plt.title("Face")

# Load the sunglass image
glassPNG = cv2.imread("C:/Users/admin/Downloads/sg.png", -1)
...
![image](https://github.com/user-attachments/assets/84ea616c-b2fb-4826-ac0c-8884bbd9455c)

![image](https://github.com/user-attachments/assets/84342c92-33a0-4b1c-8756-2fb407685ce8)

![image](https://github.com/user-attachments/assets/1c827078-cb55-46fc-8305-6f23d6442ad0)

![image](https://github.com/user-attachments/assets/c7864c02-38fb-47ce-b2ed-dac7fdd9ef62)

![image](https://github.com/user-attachments/assets/143d1d20-9d2f-4116-bf5a-46b9a82db401)
